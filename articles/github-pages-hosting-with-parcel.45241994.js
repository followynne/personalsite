...
module.bundle.HMR_BUNDLE_ID = "740757bd45241994";
"use strict";
...
},{}],"1qD1S":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
/* eslint-disable @typescript-eslint/no-unused-vars */ var _fontawesomeMinCss = require("@fortawesome/fontawesome-free/css/fontawesome.min.css");
...
const attachLbox = ()=>{
    ...
    selectGalleries.forEach((element)=>{
        ...
        const e = new _simplelightboxDefault.default(`.${classLists} .swiper-slide .card-image a`, {
            uniqueImages: false
        });
    });
};
...
_swiperDefault.default.use([_swiper.EffectCards, _swiper.Navigation, _swiper.Pagination]);
// init Swiper:
const _ = new _swiperDefault.default('.swiper', {
    // Optional parameters
    breakpoints: {
        500: {
            slidesPerView: 1
...
},{"@fortawesome/fontawesome-free/css/fontawesome.min.css":"dxfk7","@fortawesome/fontawesome-free/css/solid.min.css":"jb9q3","simplelightbox":"2BNtz","swiper":"eH5h9","swiper/swiper-bundle.min.css":"gzhta","../css/swiper.scss":"j6qbr","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dxfk7":[function() {},{}],"jb9q3":[function() {},{}],"2BNtz":[function(require,module,exports) {
...
},{}],"eH5h9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
Swiper.use([_resizeJsDefault.default, _observerJsDefault.default]);
...
function updateClickedSlide(e) {
    const swiper = this;
    const params = swiper.params;
    const slide = _domJsDefault.default(e.target).closest(`.${params.slideClass}`)[0];
...
function loopCreate() {
    ...
    const $selector = _domJsDefault.default($wrapperEl.children()[0].parentNode);
...
function A11y({ swiper , extendParams , on  }) {
    ...
    function init() {
        ...
        if ($prevEl && $prevEl.length) initNavEl($prevEl, wrapperId, params.prevSlideMessage);
         // Pagination
        if (hasPagination()) swiper.pagination.$el.on('keydown', _classesToSelectorJsDefault.default(swiper.params.pagination.bulletClass), onEnterOrSpaceKey);
    }
    function destroy() {
        ...
        if ($prevEl) $prevEl.off('keydown', onEnterOrSpaceKey);
         // Pagination
        if (hasPagination()) swiper.pagination.$el.off('keydown', _classesToSelectorJsDefault.default(swiper.params.pagination.bulletClass), onEnterOrSpaceKey);
    }
    on('beforeInit', ()=>{
...
},{"../../shared/create-shadow.js":"gVEWj","../../shared/effect-init.js":"3n9Bc","../../shared/effect-target.js":"bWadk","../../shared/effect-virtual-transition-end.js":"iCFVL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"gzhta":[function() {},{}],"j6qbr":[function() {},{}]},["lhC0W","1qD1S"], "1qD1S", "parcelRequireb8a1")

//# sourceMappingURL=github-pages-hosting-with-parcel.45241994.js.map
