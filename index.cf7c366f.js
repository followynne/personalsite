...
(()=>{
    ...
    if (popoverItem) {
        ...
        const popover = new _bootstrap.Popover(popoverItem, {
            placement: 'auto',
            trigger: 'hover',
    ...
    if (tooltipItem) {
        const tooltip = new _bootstrap.Tooltip(tooltipItem, {
            placement: 'left',
            title: 'the cool ones!'
        });
        tooltip.show();
    ...
    if (tooltipItem2) {
        const tooltip2 = new _bootstrap.Tooltip(tooltipItem2, {
            placement: 'right',
...
},{"./createPopper.js":"6w8cU","./modifiers/eventListeners.js":"6Xsje","./modifiers/popperOffsets.js":"I1CrS","./modifiers/computeStyles.js":"jb5QZ","./modifiers/applyStyles.js":"fz4DR","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["4tV6B","yEWNe"], "yEWNe", "parcelRequireb8a1")
